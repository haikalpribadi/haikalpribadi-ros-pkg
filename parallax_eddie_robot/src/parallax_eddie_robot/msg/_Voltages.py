"""autogenerated by genmsg_py from Voltages.msg. Do not edit."""
import roslib.message
import struct


class Voltages(roslib.message.Message):
  _md5sum = "0db98d790b5b039efb61505385ae8369"
  _type = "parallax_eddie_robot/Voltages"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Voltages, self).__init__(*args, **kwds)
